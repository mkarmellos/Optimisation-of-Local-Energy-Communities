...
The model is based on the [Calliope energy modelling framework](https://github.com/calliope-project/calliope) version 0.7.dev07 and has the same license (Apache 2.0). To install and run Calliope follow the instructions in the documentation.
