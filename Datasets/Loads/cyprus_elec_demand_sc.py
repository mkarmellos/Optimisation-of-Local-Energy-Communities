...
typical_load =  pd.read_excel(data_file, sheet_name = 4, header=0, index_col=0)

max_load = 20 # max load in kVA (assume equal to kW)
...
resample_typical_load_year_final_kw.set_index(date_range)
